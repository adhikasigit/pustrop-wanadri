      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Formulir Peminjaman</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          		  <div class="form-panel">
                  <h4 class="mb"><i class="fa fa-angle-right"></i> Isi Formulir Peminjaman
                  </h4>
                  <form class="form-horizontal style-form" method="post" action="add_peminjaman.php">
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">ID Peminjam</label>
                        <div class="col-sm-10">
