          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="tambah_anggota.html">Tambah Anggota</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="formulir_peminjaman.html">Formulir Peminjaman</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
            <h3><i class="fa fa-angle-right"></i> Tambah Anggota</h3>
            <div class="row mt">
              <div class="col-lg-12">
                <div class="form-panel">
                  <h4 class="mb"><i class="fa fa-angle-right"></i> Formulir Tambah Anggota
                  </h4>
                  <form class="form-horizontal style-form" method="post" action="add_member.php">
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 col-sm-2 control-label">Kode Kategori Anggota</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="kat_anggota">
                        </div>
                        <div>
